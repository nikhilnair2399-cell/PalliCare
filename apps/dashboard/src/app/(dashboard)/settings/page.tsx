      ...
      <div className="rounded-xl border border-sage-light/30 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="rounded-lg bg-cream/50 p-4">
            ...
            <p className="text-xs text-charcoal/50 mt-1">Palliative care monitoring and decision support</p>
          </div>
          <div className="rounded-lg bg-cream/50 p-4">
            <p className="text-xs font-semibold text-charcoal/50 uppercase">Version</p>
            <p className="mt-1 text-sm font-medium text-charcoal">v0.4.0-beta</p>
            <p className="text-xs text-charcoal/50 mt-1">Sprint 4 &middot; Built 18 Feb 2026</p>
          </div>
          <div className="rounded-lg bg-cream/50 p-4">
          ...
          <div className="rounded-lg bg-cream/50 p-4">
            ...
            <p className="mt-1 text-sm font-medium text-charcoal">ABDM / DISHA Compliant</p>
            <p className="text-xs text-charcoal/50 mt-1">FHIR R4 data model &middot; ABHA integration</p>
          </div>
        </div>

        {/* Legal links */}
        <div className="mt-5 flex flex-wrap items-center gap-4 border-t border-sage/10 pt-4">
          {['Privacy Policy', 'Terms of Service', 'Data Retention Policy', 'NDPS Compliance', 'Contact Support'].map((link) => (
            <button
              key={link}
